...
<body>
	...
	<div class="left">
		<ul class="menu">
			...
			<li><a href="javascript:void(0)"><i class="icon-bar-chart icon-2x"></i>&nbsp&nbsp<strong>信息管理平台</strong></a>
				<ul>
			...
			<li><a href="javascript:void(0)"><i class="icon-briefcase icon-2x"></i>&nbsp&nbsp<strong>服务功能应用</strong></a>
				<ul>
