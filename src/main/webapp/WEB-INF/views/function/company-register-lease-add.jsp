			...
			<div class="col-md-8 main">
				...
				<form class="form-horizontal" action="/addLoanDevice" method="get">
					...
					<div class="form-group">         
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control"   placeholder="批次" name="batch">
					    </div>
					  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="date" class="form-control"   placeholder="到货日期" name="arrivalDate">
				    </div>
				  </div>
				  <div class="form-group">       
				    <label class="col-sm-4 control-label">数量</label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control"   placeholder="数量" name="count">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">使用年限</label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control"   placeholder="使用年限" name="allowUseYears">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">单位价值</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="单位价值" name="unitValue">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">总价值</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="总价值" name="allValue" >
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">序号</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="序号" name="orderNumber">
				    </div>
				  </div>
				  <div class="form-group">         
				    <label class="col-sm-4 control-label">设备编号</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="设备编号" name="loanInfoId">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">使用人</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="使用人" name="loanUserName">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">所在部门</label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"   placeholder="所在部门" name="belongBranchId">
				    </div>
				  </div>
<!-- 				  <div class="form-group">   -->
...
<!-- 				  </div> -->
				  <div class="form-group">  
				    ...
				    <div class="col-sm-8">
				      <input type="date" class="form-control"   placeholder="领用日期" name="getDate">
				    </div>
				  </div>
				  <div class="form-group">  
				    <label class="col-sm-4 control-label">到期时间</label>
				    <div class="col-sm-8">
				      <input type="date" class="form-control"   placeholder="到期时间" name="expiredDate">
				    </div>
				  </div>
				  <div class="form-group">
