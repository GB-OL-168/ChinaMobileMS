		...
		<div class="row">
			<div class="col-md-12 main">
				...
				<form action="/searchASF" method="get">
					<div class="col-md-7">
						<span>请选择相关的搜索条件：</span> <input type="radio" name="asf"
							value="furnitureType" required>家具类型 <input type="radio"
							name="asf" value="brand" required>品牌型号 <input
							type="radio" name="asf" value="branchName" required>使用部门
						<input type="radio" name="asf" value="building"
							style="display: inline-block" required>所在建筑
					</div>
					<div class="col-md-5">
