...
public class DinnerPropertyTableEntity {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DinnerPropertyTableEntity other = (DinnerPropertyTableEntity) obj;
		if (addition == null) {
	...
	public String toString() {
		return "DinnerPropertyTableEntity [dinnerPropertyTableId=" + dinnerPropertyTableId + ", applyOrChargeUserName="
				+ applyOrChargeUserName + ", branchId=" + branchId + ", companyId=" + companyId + ", startDate="
				+ startDate + ", finishDate=" + finishDate + ", contactInfo=" + contactInfo + ", arrangePersonCount="
				+ arrangePersonCount + ", dinnerType=" + dinnerType + ", addition=" + addition + ", status=" + status
				+ ", applyTime=" + applyTime + "]";
	}
}
